...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@/components/console/ui/sheet";
import { Skeleton } from "@/components/console/ui/skeleton";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/console/ui/tooltip";
...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<"main">>(
  ({ className, ...props }, ref) => {
    return (
      <main
        ref={ref}
        className={cn("relative flex w-full flex-1 bg-[#D9EDFE25] flex-col", className)}
        {...props}
      />
    );
  }
